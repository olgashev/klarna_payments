...
class Klarna_Payments_Helper_Checkout extends Mage_Core_Helper_Abstract
{
    ...
    public function createCheckHashes()
    {
        ...
        $orderItemRequestToken = md5($checkoutSession->getQuoteId() . ':' . Zend_Json::encode($checkItems));
        $requestToken          = md5($checkoutSession->getQuoteId() . ':' . Zend_Json::encode($createRequest));
